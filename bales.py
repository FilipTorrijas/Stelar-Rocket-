...
def mostrar_menu():
    ...
    img1 = font1.render("Rocket Star", True, MAGENTA)
...
def mostrar_credits():
    ...
    img1 = font1.render("Space Rocket!", True, MAGENTA)
    ...
    img6 = font3.render("Felipe Torrejón:", True, BLUE)
    img7 = font3.render("Al safir ", True, BLUE)
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if pantalla_actual == 1:
            ambient_music = pygame.mixer.Sound('assets/space.mp3')
            ambient_music.play()
            if event.type == KEYDOWN:
                if event.key == K_1:
                    pantalla_actual = 3
        ...
        if pantalla_actual == 3:
            if event.type == KEYDOWN:
                ...
                if event.key == K_w and current_time - temps_ultima_bala_jugador1 >= temps_entre_bales:
                    ...
                    pygame.mixer.music.load('assets/glock19-18535.mp3')
